								...
								<div class="row">
									<div class="col-md-6">
										<div class="d-grid mb-2 mb-md-0">
                                            @guest
                                            <a href="{{route('vendors.registration')}}" class="btn btn-danger" wire:navigate>
                                            ...
                                            @else
                                            <a href="{{route('catalogue.product')}}" class="btn btn-danger" wire:navigate>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M12 15c3.186 0 6.045.571 8 3.063V20H4v-1.937C5.955 15.57 8.814 15 12 15m0-3a4 4 0 1 1 0-8a4 4 0 0 1 0 8m8 2a1 1 0 0 1-2 0v-1h-1a1 1 0 0 1 0-2h1v-1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 0 2h-1z"/></svg>
									...
									<div class="col-md-6">
										<div class="d-grid">
											<a href="{{route('boutique.index')}}" class="btn btn-outline-secondary" wire:navigate><i class="fe fe-shopping-cart me-2"></i>Consulter les boutiques</a>
										</div>
									</div>
								</div>
							</div>
