            ...
            <div class="card-body p-xl-6">
                <div class="mb-4">
                    ...
                    <div class="mt-3 mb-5 row g-2">
                       ...
                       <span class="text-center">Cliquer ici pour vous inscrire en tant que vendeur <a href="{{route('vendors.registration')}}" wire:navigate>Devenir vendeur</a></span>
                    </div>
                </div>
                <div class="mb-4">
            ...
            <div class="card-footer px-6 py-4 text-center">
                <p class="mb-0">
                   Vous n'avez pas de compte alors
                    <a href="{{route('login')}}" class="text-inherit fw-semibold" wire:navigate>Connexion </a>
                </p>
            </div>
        </div>
