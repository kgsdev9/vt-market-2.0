            ...
            <div>
                <div class="col-lg-12">
                    ...
                    <div class="d-grid mt-4">
                        <a href="{{route('sommary.orders')}}" class="btn btn-outline-secondary text-dark" wire:navigate>
        ...
        <div class="container row-justify-content-center text-center">
            <div class="card mt-4">
                <div class="card-body">
                    ...
                    <a  href="{{route('catalogue.product')}}" class="btn btn-outline-secondary" wire:navigate>
