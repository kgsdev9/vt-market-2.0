            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © VTP MARKET .
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Propolsé par  <i class="mdi mdi-heart text-danger"></i> by <a href="#" target="_blank" class="text-reset">KGS INFORMATIQUE </a>
                                </div>
                            </div>
                        </div>
                    </div>
